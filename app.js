...
const loansInvestmentsRouters = require('./routes/apis/admin/loanInvestments');
...
app.use('/api/v1/admin/loans/investments/', passport.authenticate('jwt', {session: false}), loansInvestmentsRouters);
